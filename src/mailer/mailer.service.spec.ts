...
describe('MailerService', () => {
    ...
    describe('sendMail with real email configuration', () => {
        ...
        it('should send an email', async () => {
            ...
            await service.sendMail(emailDetails.to, emailDetails.subject, emailDetails.text);
    ...
    describe('sendMail with dummy email configuration', () => {
        ...
        it('should log dummy email content', async () => {
            ...
            expect(console.log).toHaveBeenCalledWith(`From: "NestJS User Management" <costopoulos.constantinos@gmail.com>`);
            expect(console.log).toHaveBeenCalledWith(`To: ${emailDetails.to}`);
            expect(console.log).toHaveBeenCalledWith(`Subject: ${emailDetails.subject}`);
